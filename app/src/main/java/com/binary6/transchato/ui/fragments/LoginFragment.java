...
import com.binary6.transchato.core.login.LoginContract;
import com.binary6.transchato.core.login.LoginPresenter;
import com.binary6.transchato.ui.activities.RegisterActivity;
import com.binary6.transchato.ui.activities.UserListingActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void setDummyCredentials() {
        mETxtEmail.setText("sami@test.com");
        mETxtPassword.setText("1234567890");
    }
    ...
    private void onLogin(View view) {
        ...
        String password = mETxtPassword.getText().toString();
            ...
            {
              Toast.makeText(getActivity(),"Value should not empty",Toast.LENGTH_LONG).show();
            }else
            {
